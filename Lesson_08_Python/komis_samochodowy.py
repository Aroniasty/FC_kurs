...
print("Witaj w programie do obsługi komisu samochodowego. Co chcesz zrobić aktualnie?")
koniec_programu = False
while not koniec_programu:
    wybor_opcji = input("Podaj co chcesz zrobić: ")
    if wybor_opcji == "kupno":
        marka_auta = input("Podaj markę: ")
        model_auta = input("Podaj model: ")
        przebieg_auta = input("Podaj przebieg: ")
        cena_auta = input("Podaj cenę: ")
